  ...
  return (
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 900px) {
          ...
          div[style*="justify-content: space-between"] { flex-wrap: wrap !important; justify-content: center !important; }
        }
      ...
      <section className="hero">
        <div className="hero-bg" style={{ backgroundImage: "url('/blocks-banner.png')" }} />
        <div className="hero-overlay" style={{ background: "transparent" }} />
        <div className="hero-content">
          <h1 className="hero-heading" style={{ color: '#1a1f24', fontSize: 'clamp(50px, 6vw, 84px)', fontWeight: '400' }}>Lite Block</h1>
          <div className="hero-bottom-area" style={{ maxWidth: '440px' }}>
            <p className="hero-body" style={{ color: '#fff', textShadow: '0 1px 4px rgba(0,0,0,0.5)', fontWeight: '400' }}>
              Lite Block is a versatile, durable, and lightweight solution, ideal for various construction projects—from residential homes and warehouses to high-rise and commercial buildings.
            </p>
            <div className="hero-actions">
              <button className="btn-work">See Our Work</button>
              <div className="explore-wrap" style={{ color: '#2a3a44' }}>
                <div className="explore-icon" style={{ borderColor: '#2a3a44' }}>
                ...
                <div className="explore-line" style={{ background: '#2a3a44' }}></div>
      ...
      <section className="clc-block-section" style={{ display: 'flex', maxWidth: '1300px', margin: '140px auto 160px', padding: '0 60px', gap: '80px', alignItems: 'center' }}>
        <div className="clc-text" style={{ flex: '1', fontFamily: 'Inter, sans-serif' }}>
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: '42px', color: '#2a3a44', fontWeight: '400', marginBottom: '30px' }}>Lite CLC Block</h2>
          <p style={{ fontSize: '15px', color: '#889bb0', lineHeight: '1.8', marginBottom: '20px' }}>
            We use Cellular Lightweight Concrete Blocks in all our construction, supplementing them with traditional concrete blocks where necessary. Cellular Lightweight Concrete Block is an innovative building material gaining popularity worldwide due to its numerous advantages over traditional concrete blocks. Cellular Light-weight Concrete (CLC) also know as foam concrete is a form of lightweight concrete made of sand, cement, water and foam.
          </p>
          <p style={{ fontSize: '15px', color: '#889bb0', lineHeight: '1.8' }}>
            CLC is a versatile, durable, and lightweight solution, ideal for various construction projects—from residential homes and warehouses to high-rise and commercial buildings. Widely adopted in Europe and Asia, this advanced technology is now available in Ghana, offering a superior alternative for your construction needs.
          </p>
        </div>
        <div className="clc-img-wrap" style={{ flex: '1', position: 'relative' }}>
          <img src="/services-blocks.png" alt="CLC Block" style={{ width: '100%', display: 'block', borderRadius: '4px' }} />
          <div className="annotation" style={{ position: 'absolute', top: '40%', right: '15%', display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
            <div style={{ position: 'relative', width: '40px', height: '40px' }}>
               <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#00c2ff', position: 'absolute', bottom: '0', left: '0' }}></div>
               <svg style={{ position: 'absolute', bottom: '4px', left: '4px' }} width="40" height="40" overflow="visible">
                 <line x1="0" y1="36" x2="16" y2="0" stroke="#00c2ff" strokeWidth="1.5"/>
                 <line x1="16" y1="0" x2="40" y2="0" stroke="#00c2ff" strokeWidth="1.5"/>
               </svg>
            </div>
            <span style={{ fontSize: '10px', fontWeight: '600', color: '#333', letterSpacing: '0.5px', marginTop: '-4px' }}>CEMENT, LIME, SILICA SAND</span>
          </div>
        </div>
      </section>

      {/* ADVANTAGES SECTION */}
      <section className="advantages-section" style={{ display: 'flex', maxWidth: '1200px', margin: '0 auto 80px', padding: '0 60px', alignItems: 'center', gap: '80px' }}>
        <div style={{ flex: '1.2' }}>
          <div style={{ width: '100%', aspectRatio: '16/9', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
            <img src="/advantage.png" alt="Advantages visual" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
        </div>
        <div style={{ flex: '1' }}>
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: '38px', color: '#2a3a44', fontWeight: '400', marginBottom: '24px' }}>Advantages</h2>
          <ul style={{ listStyle: 'none', color: '#889bb0', fontSize: '15px', lineHeight: '2.0', fontWeight: '500' }}>
            <li>Lightweight</li>
            <li>No plastering needed</li>
            <li>Fewer rebars</li>
            <li>Fewer breakages</li>
            <li>Savings on sand, cement and steel</li>
            <li>Fire Resistance</li>
            <li>Lower water absorption</li>
            <li>Sound insulation</li>
            <li>Thermal Insulation</li>
            <li>Low structural load</li>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 80px', padding: '0 60px' }}>
        <div style={{ background: '#eef2f9', borderRadius: '12px', padding: '30px 40px', display: 'flex', justifyContent: 'space-between', gap: '20px' }}>
          {[
            { img: "services-blocks.png", label: "Minimal Mortar use" },
            { img: "services-blocks.png", label: "Light weight" },
            { img: "services-blocks.png", label: "Fire Proof" },
            { img: "services-blocks.png", label: "Water proof" },
            { img: "services-blocks.png", label: "Not easily breakable" }
          ].map((feat, idx) => (
            <div key={idx} style={{ flex: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '100%', aspectRatio: '4/3', overflow: 'hidden', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <img src={`/${feat.img}`} alt={feat.label} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#889bb0', textAlign: 'center' }}>{feat.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ display: 'flex', maxWidth: '1200px', margin: '0 auto 120px', padding: '0 60px', alignItems: 'center', gap: '60px' }}>
        ...
        <div style={{ flex: '1', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '80%', aspectRatio: '1/1', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
             <img src="/services-blocks.png" alt="Custom block designs" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
        </div>
      </section>
      ...
      <section style={{ display: 'flex', maxWidth: '1200px', margin: '0 auto 80px', padding: '0 60px', alignItems: 'stretch' }}>
        <div style={{ flex: '0 0 320px', background: '#ccc' }}>
          <img src="/services-blocks.png" alt="Block Wall" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        </div>
        <div style={{ flex: '1', background: '#f8f7f5', padding: '60px 80px', fontFamily: 'Inter, sans-serif' }}>
          <h2 style={{ fontSize: '26px', color: '#1a1f24', fontWeight: '500', marginBottom: '40px', paddingBottom: '20px', borderBottom: '1px solid #e0dfdc' }}>Need Blocks, or have a custom design?</h2>
